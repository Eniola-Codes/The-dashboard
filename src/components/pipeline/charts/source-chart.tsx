...
export function SourceChart({ metrics }: { metrics: PipelineMetrics }) {
  const { hasDeals, sourceChartData } = useChartData(metrics)
  ...
  return (
    <Card className="w-full">
      <CardHeader>
        ...
        <CardDescription>
          Total pipeline value vs won value per lead channel
        </CardDescription>
      </CardHeader>
      <CardContent>
        {hasDeals ? (
